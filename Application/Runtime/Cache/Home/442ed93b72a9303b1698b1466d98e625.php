...
<head>
    ...
    <link rel="stylesheet" href="/axd/Public/css/integral.css">
    <script src="/axd/Public/js/jquery-1.12.4.js"></script>
    <script src="/axd/Public/js/unified.js"></script>
    <script src="/axd/Public/js/integral.js"></script>
</head>
<script>
    $(function(){
        $('.t_btn').click(function(){
            $.ajax({
                url: "/axd/Home/User/exchangeGoods?"+Math.random(),
...
<div id="information">
    <div class="information_box">
        <form action="<?php echo U('User/exchangeGoods');?>" method="POST" id="exchange_form">
        <div class="title">
            <ul>
                <li>
                    <div class="share_fork"></div>
                </li>
                <li>
                    <span>兑换的礼物</span>
                </li>
                <li class="t_info">
                    <p class="t_name">宽松西装开衫马甲</p>
                    <p class="t_integral">2000积分</p>
                    <input type="hidden" value="" name="i_gid"/>
                </li>
            </ul>
        </div>
        <div class="footer">
            <ul>
                ...
                <li>
                    <label>地&nbsp;&nbsp;&nbsp;&nbsp;址</label>
                    <textarea placeholder="请填写您的详细地址" name="address"></textarea>
                </li>
                <li>
                    <input class="t_btn" type="button" value="提交">
                </li>
            </ul>
        </div>
        </form>
...
<div id="couples" class="clear">
    <div class="couples_box">
        <div class="baby_details">
            <ul>
                <?php if(is_array($goods_list)): foreach($goods_list as $key=>$g): ?><li data-i_gid="<?php echo ($g["i_goods_id"]); ?>">
                    <a href="javascript:;">
                        <div class="baby_img">
                    ...
                    <div class="baby_price">
                        <div class="price">
                            <span><?php echo ($g["integral"]); ?>积分</span>
                        </div>
                        <div class="praise">
                            <p>兑换</p>
                        </div>
