...
<!--头部文件-->
    ...
    <script type="text/javascript">
        ...
        var CONTROLLER = "/mgctdh/Admin/Admin";
        var ACTION = "/mgctdh/Admin/Admin/adminRoleList";
    </script>
</head>
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <!--<div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/mgctdh/Admin/Admin/adminRoleList" id="sf">
