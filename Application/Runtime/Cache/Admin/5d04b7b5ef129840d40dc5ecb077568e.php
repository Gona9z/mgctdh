...
<!--左侧导航栏-->
    <div class="main-content">
        ...
        <div id="commodity_details">
            <h1><img src="/axd/Public/back_img/ico.png"><?php if(empty($_GET['id'])): ?>添加<?php else: ?>修改<?php endif; ?>积分商品
                <a href="javascript:history.go(-1);"><span><img src="/axd/Public/back_img/return.png"></span></a></h1>
            <div id="commodity_list">
                <!--通用信息_开始-->
                <form action="/axd/Admin/Integral/dealIOrder" method="post" id="edit_form" enctype="multipart/form-data" >

                    <div id="commodity_main" class="clear">
                        <table>
                            <input type="hidden" value="<?php echo ($order['i_order_id']); ?>" name="io_id">
                            <tr>
                                <th>名称：</th>
                                <td><input type="text" value="<?php echo ($order["good_name"]); ?>" disabled="true" ></td>
                            </tr>
                            <tr>
                                <th>商品图片：</th>
                                <td><img src="/axd<?php echo ($order["image"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>联系人：</th>
                                <td><input type="text" value="<?php echo ($order["link_name"]); ?>" disabled="true" ></td>
                            </tr>
                            <tr>
                                <th>联系电话：</th>
                                <td><input type="text" value="<?php echo ($order["link_phone"]); ?>" disabled="true" ></td>
                            </tr>
                            <tr>
                                <th>地址：</th>
                                <td><textarea disabled="true" ><?php echo ($order["address"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th>管理员备注：</th>
                                <td><input type="text" value="" name="admin_note"></td>
                            </tr>
                        </table>
                    </div>
...
<script>
    ...
    $('#li1_btn').click(function(){
        $('#edit_form').ajaxSubmit({
            url:"/axd/Admin/Integral/dealIOrder",
            dataType: "json",
            beforeSend: function() {
