    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">搭配分类列表</li>
                <li class="active">编辑搭配分类</li>
            </ul><!-- .breadcrumb -->
        </div>

        <div id="commodity_details">
            <h1><img src="/axd/Public/back_img/ico.png"><?php if(empty($_GET['id'])): ?>添加<?php else: ?>修改<?php endif; ?>搭配分类
                <a href="javascript:history.go(-1);"><span><img src="/axd/Public/back_img/return.png"></span></a></h1>
            <div id="commodity_list">
                <!--通用信息_开始-->
                <form action="/axd/Admin/Collocation/addEditCollocation" method="post" id="edit_form" enctype="multipart/form-data" >
                    ...
                    <div id="commodity_main" class="clear">
                        <table>
                            ...
                            <tr class="class_b_b">
                                ...
                                <td>
                                    <div class="class_list">
                                        <?php if(!empty($collocation["image"])): ?><img src="/axd<?php echo ($collocation["image"]); ?>" id="to_img">
                                            <?php else: ?>
                            ...
                            <tr>
                                <th>搭配分类：</th>
                                <td>
                                    <select name="c_cate_id">
                                        <?php if(is_array($collocation_cate)): foreach($collocation_cate as $key=>$cc): ?><option value="<?php echo ($cc["c_cate_id"]); ?>"
                                        <?php if($cc['c_cate_id'] == $collocation['c_cate_id']): ?>selected="selected"<?php endif; ?>
                                        ><?php echo ($cc["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <th>搭配标题：</th>
                                <td><input type="text" name="title" value="<?php echo ($collocation["title"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>搭配标签：</th>
                                <td>
                                    <textarea name="label_text_arr"><?php echo ($collocation["label_text"]); ?></textarea>
                                    <span>每一行为一个标签</span>
                                </td>
                            </tr>
                            <tr>
                                <th>搭配介绍：</th>
                                <td>
                                    <textarea name="introduce"><?php echo ($collocation["introduce"]); ?></textarea>
                                </td>
                            </tr>
                            <!--<tr class="edit_goods">
                                <th>商品编辑：</th>
                    ...
                    <!--<table class="table table-bordered">
                        ...
                        <tbody id="goods_body">
                        <?php if(is_array($node_list)): foreach($node_list as $k=>$l): ?><tr>
                                <td>
                                ...
                                <td class="operation">
                                    <a href="javaScript:void(0);" onclick="delCollocation('<?php echo ($l["collocation_id"]); ?>');">删除</a>
                                </td>
...
//        return;
        $('#edit_form').ajaxSubmit({
            url:"/axd/Admin/Collocation/addEditCollocation",
            dataType: "json",
            beforeSend: function() {
