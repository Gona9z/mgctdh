...
<!--头部文件-->
    ...
    <style>
        ...
        tr img{width:108px;height:60px;}
    </style>
    <script type="text/javascript">
        var APP = "/axd";
        var MODULE = "/axd/Admin";
        var CONTROLLER = "/axd/Admin/Subject";
        var ACTION = "/axd/Admin/Subject/subjectList";
    </script>
</head>
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/axd/Admin/Subject/subjectList" id="sf">
                        <div class="input-group" style="margin-bottom: 3%;">
                            <input type="text" class="form-control" placeholder="专题名称搜索" value="<?php echo ($keyword); ?>" name="keyword">
                            <a onClick="document.getElementById('sf').submit();" class="input-group-addon"><i class="icon-search"></i></a>
                        </div>
                    </form>
                </div>
                <a href="<?php echo U('Admin/Subject/addEditSubject');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td class="operation">
                            <a href="<?php echo U('Admin/Subject/addEditSubject',array('id'=>$l['subject_id']));?>">编辑</a>
                            <!--<a href="<?php echo U('Admin/Subject/editSubjectGoods',array('id'=>$l['subject_id']));?>">编辑商品</a>-->
                            <a href="javaScript:void(0);" onclick="delSubject('<?php echo ($l["subject_id"]); ?>');">删除</a>
                        </td>
...
<script>
    ...
    function delSubject(id){
        if(confirm("是否删除该数据")){
            $.post("<?php echo U('Admin/Subject/delSubject');?>",{'id':id},function(data){
                alert(data.msg);
                if('0'==data.errorCode){
