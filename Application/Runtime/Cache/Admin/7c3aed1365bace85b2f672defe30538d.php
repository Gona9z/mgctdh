...
<!--头部文件-->
    ...
    <style>
        ...
        tr img{width:50px;height:50px;}
        #home a{margin-bottom: 10px;}
    </style>
    <script type="text/javascript">
        var APP = "/axd";
        var MODULE = "/axd/Admin";
        var CONTROLLER = "/axd/Admin/Collocation";
        var ACTION = "/axd/Admin/Collocation/collocationCate";
    </script>
</head>
    ...
    <div class="main-content">
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <a href="<?php echo U('Admin/Collocation/addEditCCate');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td><?php echo ($l["order_n"]); ?></td>
                        <td class="operation">
                            <a href="<?php echo U('Admin/Collocation/addEditCCate',array('id'=>$l['c_cate_id']));?>">编辑</a>
                            <a href="javaScript:void(0);" onclick="delCCate('<?php echo ($l["c_cate_id"]); ?>');">删除</a>
                        </td>
...
<script>
    ...
    $(".dpgl .dpfllb").addClass("active");
</script>
<script>
    //删除搭配分类
    function delCCate(id){
        if(confirm("是否删除该数据")){
            $.post("<?php echo U('Admin/Collocation/delCCate');?>",{'id':id},function(data){
                alert(data.msg);
                if('0'==data.errorCode){
