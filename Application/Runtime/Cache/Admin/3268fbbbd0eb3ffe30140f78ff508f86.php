        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="search">
                <div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/axd/Admin/Goods/goodsList" id="sf">
            ...
            <table class="table table-bordered" id="list-table">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        <td><?php echo ($l["goods_id"]); ?></td>
                        <td><p class="td_a"><?php echo ($l["name"]); ?></p></td>
                        <td><img src="/axd<?php echo ($l["image"]); ?>" alt=""></td>
                        <td><?php echo ($l["cate_name"]); ?></td>
                        <td><?php echo ($l["price"]); ?>元</td>
                        <td><?php echo ($l["collect_count"]); ?></td>
                        <td><?php echo ($l["comment_count"]); ?></td>
                        <td>
                            <?php if(NOW_TIME> ($l['end_time']+86400)): ?><spna style="color:red;"><?php echo (date('Y-m-d',$l["end_time"])); ?></spna>
                            <?php else: ?>
