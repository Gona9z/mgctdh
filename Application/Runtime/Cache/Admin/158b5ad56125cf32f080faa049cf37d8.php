...
<!--头部文件-->
    ...
    <script type="text/javascript">
        ...
        var ACTION = "/axd/Admin/User/schoolList";
    </script>
</head>
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/axd/Admin/User/schoolList" id="sf">
                        <div class="input-group" style="margin-bottom: 3%;">
                            <input type="text" class="form-control" placeholder="学校名称搜索" value="<?php echo ($keyword); ?>" name="keyword">
                            <a onClick="document.getElementById('sf').submit();" class="input-group-addon"><i class="icon-search"></i></a>
                        </div>
                    </form>
                </div>
                <a href="<?php echo U('Admin/User/addSchool');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td class="operation">
                            <!--<a href="<?php echo U('Admin/User/addEditSchool',array('id'=>$l['normal_cate_id']));?>">编辑</a>-->
                            <a href="javaScript:void(0);" onclick="delSchool('<?php echo ($l["school_id"]); ?>');">删除</a>
                        </td>
...
<script>
    ...
    $(".hygl .xxlb").addClass("active");
</script>
<script>
    //删除学校数据
    function delSchool(id){
        if(confirm("是否删除该数据")){
            $.post("<?php echo U('Admin/User/delSchool');?>",{'id':id},function(data){
                alert(data.msg);
                if('0'==data.errorCode){
