...
<!--头部文件-->
    ...
    <style>
        select{width: 20%;float: left;height: 35px;}
    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">淘宝订单列表</li>
            </ul><!-- .breadcrumb -->
        </div>
        <div id="myTabContent" class="tab-content">
            <form class="bs-example bs-example-form" action="/axd/Admin/Goods/tbOrder" id="sf">
            <div class="tab-pane fade in active" id="home">
                <select name="school_id">
                    <option value="0">全部</option>
                    <?php if(is_array($school_list)): foreach($school_list as $key=>$s): ?><option value="<?php echo ($s["school_id"]); ?>"
                    <?php if($s['school_id'] == $school_id): ?>selected="true"<?php endif; ?>
                    ><?php echo ($s["name"]); ?></option><?php endforeach; endif; ?>
                </select>
                <div class="col-sm-4 col-xs-6">
                        <div class="input-group" style="margin-bottom: 3%;">
                            <input type="text" class="form-control" placeholder="用户昵称/订单搜索" value="<?php echo ($keyword); ?>" name="keyword">
            ...
            <table class="table table-bordered">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td><?php echo (date('Y-m-d H:i:s',$l["add_time"])); ?></td>
                        <td>
                            <?php if($l['is_deal'] == 0): ?><p style="color:blue;">订单已提交</p>
                                <?php else: ?>
                                <p style="color:green;">已提交拿快递</p><?php endif; ?>
                        </td>
                        <!--<td class="operation">-->
                            <!--<a href="javaScript:void(0);" onclick="delLaw('<?php echo ($n["id"]); ?>');">处理</a>-->
                        <!--</td>-->
