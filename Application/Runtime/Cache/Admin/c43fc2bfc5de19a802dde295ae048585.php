        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/axd/Admin/Collocation/collocationList" id="sf">
                        <div class="input-group" style="margin-bottom: 3%;">
                            <input type="text" class="form-control" placeholder="标题搜索" value="<?php echo ($keyword); ?>" name="keyword">
                            <a onClick="document.getElementById('sf').submit();" class="input-group-addon"><i class="icon-search"></i></a>
                        </div>
                    </form>
                </div>
                <a href="<?php echo U('Admin/Collocation/addEditCollocation');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th>序号</th>
                    <th>分类名称</th>
                    <th class="tr_width_3">搭配标题</th>
                    <th>专题图片</th>
                    <th class="tr_width_3">介绍</th>
                    <!--<th>是否推荐</th>-->
                    <th>操作</th>
                </tr>
                </thead>
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td><img src="/axd<?php echo ($l["image"]); ?>"></td>
                        <td><?php echo ($l['introduce_s']); ?></td>
                        <!--<td><?php echo ($l['is_tuijian']==0?'否':'是'); ?></td>-->
                        <td class="operation">
                            <a href="<?php echo U('Admin/Collocation/addEditCollocation',array('id'=>$l['collocation_id']));?>">编辑</a>
                            <a href="<?php echo U('Admin/Collocation/addEditCGoods2',array('id'=>$l['collocation_id']));?>">编辑商品</a>
...
<script>
    //删除搭配
    function delCollocation(id){
        if(confirm("是否删除该数据")){
            $.post("<?php echo U('Admin/Collocation/delCollocation');?>",{'id':id},function(data){
                alert(data.msg);
                if('0'==data.errorCode){
