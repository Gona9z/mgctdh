    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">添加文章商品</li>
            </ul><!-- .breadcrumb -->
        </div>

        <div id="commodity_details">
            <h1><img src="/axd/Public/back_img/ico.png"><?php if(empty($_GET['id'])): ?>添加<?php else: ?>修改<?php endif; ?>文章商品
                <a href="javascript:history.go(-1);"><span><img src="/axd/Public/back_img/return.png"></span></a></h1>
            <div id="commodity_list">
                <!--通用信息_开始-->
                <form action="/axd/Admin/Subject/addSubjectGoodsPage" method="post" id="goods_form" enctype="multipart/form-data" >
...
<script>
    ...
    $('#li1_btn').click(function(){
        $('#goods_form').ajaxSubmit({
            url:"/axd/Admin/Subject/addSubjectGoodsPage",
            dataType: "json",
            beforeSend: function() {
