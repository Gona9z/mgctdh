...
<!--头部文件-->
    ...
    <script src="/mgctdh/Public/back_js/goods_addEdit.js"></script>
    <style>
...
<!--左侧导航栏-->
    <div class="main-content">
        ...
        <div id="commodity_details">
            <h1><img src="/mgctdh/Public/back_img/ico.png"><?php if(empty($_GET['id'])): ?>添加<?php else: ?>修改<?php endif; ?>商家信息
                <a href="javascript:history.go(-1);"><span><img src="/mgctdh/Public/back_img/return.png"></span></a></h1>
            <div id="commodity_list">
                <!--通用信息_开始-->
                <form action="/mgctdh/Admin/Merchant/addEditMerchant" method="post" id="goods_form" enctype="multipart/form-data" >

                    <div id="commodity_main" class="clear">
                        <table>
                            <input type="hidden" value="<?php echo ($merchant['merchant_id']); ?>" name="id">
                            <tr>
                                <th>商家名称：</th>
                                <td><input type="text" name="merchant_name" value="<?php echo ($merchant["merchant_name"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>商家地址：</th>
                                <td><input type="text" name="merchant_address" value="<?php echo ($merchant["merchant_address"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>商家电话</th>
                                <td><input type="text" name="merchant_phone" value="<?php echo ($merchant["merchant_phone"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>菜系：</th>
                                <td><input type="text" name="cuisine" value="<?php echo ($merchant["cuisine"]); ?>"></td>
                            </tr>
                        </table>
                    </div>
...
<script>
    ...
    $('#li1_btn').click(function(){
        $('#goods_form').ajaxSubmit({
            url:"/mgctdh/Admin/Merchant/addEditMerchant",
            dataType: "json",
            beforeSend: function() {
