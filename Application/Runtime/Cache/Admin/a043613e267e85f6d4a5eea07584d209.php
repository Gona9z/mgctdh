    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">校趣分类列表</li>
            </ul><!-- .breadcrumb -->
        </div>
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <a href="<?php echo U('Admin/Interact/addEditICate');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td class="operation">
                            <a href="<?php echo U('Admin/Interact/addEditICate',array('id'=>$l['s_cate_id']));?>">编辑</a>
                            <a href="javaScript:void(0);" onclick="delICate('<?php echo ($l["s_cate_id"]); ?>');">删除</a>
                        </td>
...
<script>
    ...
    $(".xqgl .xqfllb").addClass("active");
</script>
<script>
    //删除校趣分类
    function delICate(id){
        if(confirm("是否删除该数据")){
            $.post("<?php echo U('Admin/Interact/delICate');?>",{'id':id},function(data){
                alert(data.msg);
                if('0'==data.errorCode){
