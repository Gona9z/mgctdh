...
<!--左侧导航栏-->
    <div class="main-content">
        ...
        <div id="commodity_details">
            <h1><img src="/mgctdh/Public/back_img/ico.png"><?php if(empty($_GET['id'])): ?>添加<?php else: ?>修改<?php endif; ?>礼品卡
                <a href="javascript:history.go(-1);"><span><img src="/mgctdh/Public/back_img/return.png"></span></a></h1>
            <div id="commodity_list">
                <!--通用信息_开始-->
                <form action="/mgctdh/Admin/Index/addEditGiftCard" method="post" id="goods_form" enctype="multipart/form-data" >

                    <div id="commodity_main" class="clear">
                        <table>
                            <input type="hidden" value="<?php echo ($gc['gift_card_id']); ?>" name="id">
                            <tr>
                                <th>名称：</th>
                                <td><input type="text" value="<?php echo ($gc['title']); ?>" name="title"></td>
                            </tr>
                            <tr>
                                <th>图片：</th>
                                <td>
                                    <?php if(!empty($gc['image'])): ?><img src="/mgctdh<?php echo ($gc['image']); ?>" id="to_img">
                                        <?php else: ?>
                            ...
                            <tr>
                                <th>披萨：</th>
                                <td><input type="text" value="<?php echo ($gc["pizza"]); ?>" name="pizza"></td>
                            </tr>
                            <tr>
                                <th>数量：</th>
                                <td><input type="text" name="num" value="<?php echo ($gc["num"]); ?>"></td>
                            </tr>
                        </table>
                    </div>
...
<script>
    ...
    $('#li1_btn').click(function(){
        $('#goods_form').ajaxSubmit({
            url:"/mgctdh/Admin/Index/addEditGiftCard",
            dataType: "json",
            beforeSend: function() {
