...
<!--头部文件-->
    ...
    <script type="text/javascript">
        ...
        var ACTION = "/axd/Admin/Subject/subjectCate";
    </script>
</head>
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/axd/Admin/Subject/subjectCate" id="sf">
                        <div class="input-group" style="margin-bottom: 3%;">
                            <input type="text" class="form-control" placeholder="分类名称搜索" value="<?php echo ($keyword); ?>" name="keyword">
                            <a onClick="document.getElementById('sf').submit();" class="input-group-addon"><i class="icon-search"></i></a>
                        </div>
                    </form>
                </div>
                <a href="<?php echo U('Admin/Subject/addEditSubjectCate');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td class="operation">
                            <a href="<?php echo U('Admin/Subject/addEditSubjectCate',array('id'=>$l['s_cate_id']));?>">编辑</a>
                            <a href="javaScript:void(0);" onclick="delSCate('<?php echo ($l["s_cate_id"]); ?>');">删除</a>
                        </td>
...
<script>
    ...
    $(".wzgl .wzfllb").addClass("active");
</script>
<script>
    //删除文章分类
    function delSCate(id){
        if(confirm("是否删除该数据")){
            $.post("<?php echo U('Admin/Subject/delSCate');?>",{'id':id},function(data){
                alert(data.msg);
                if('0'==data.errorCode){
