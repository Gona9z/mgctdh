...
<!--头部文件-->
    ...
    <script type="text/javascript">
        ...
        var ACTION = "/axd/Admin/Admin/adminUserList";
    </script>
</head>
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/axd/Admin/Admin/adminUserList" id="sf">
                ...
                <a href="<?php echo U('Admin/Admin/addEditAdmin');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td><?php echo (date('Y-m-d H:i:s',$l["last_login"])); ?></td>
                        <!--<td><?php echo ($l["last_ip"]); ?></td>-->
                        ...
                        <td class="operation">
                            <?php if($l['admin_id'] != 1): ?><a href="<?php echo U('Admin/Admin/addEditAdmin',array('id'=>$l['admin_id']));?>">编辑</a>
                            <a href="javaScript:void(0);" onclick="delAdmin('<?php echo ($l["admin_id"]); ?>');">删除</a><?php endif; ?>
                        </td>
...
<script>
    ...
    function delAdmin(id){
        if(confirm("是否删除该数据")){
            $.post("<?php echo U('Admin/Admin/delAdmin');?>",{'id':id},function(data){
                alert(data.msg);
                if('0'==data.errorCode){
