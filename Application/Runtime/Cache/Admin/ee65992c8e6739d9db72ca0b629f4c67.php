    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">编辑搭配</li>
            </ul><!-- .breadcrumb -->
        </div>

        <div id="commodity_details">
            <h1><img src="/axd/Public/back_img/ico.png"><?php if(empty($_GET['id'])): ?>添加<?php else: ?>修改<?php endif; ?>搭配
                <a href="javascript:history.go(-1);"><span><img src="/axd/Public/back_img/return.png"></span></a></h1>
            <div id="commodity_list">
                <!--通用信息_开始-->
                <form action="/axd/Admin/Collocation/addEditCCate" method="post" id="edit_form" enctype="multipart/form-data" >

                    <div id="commodity_main" class="clear">
                        <table>
                            <input type="hidden" value="<?php echo ($cate['c_cate_id']); ?>" name="id">
                            <tr>
                                <th>分类名称：</th>
                            ...
                            <tr class="class_b_b">
                                <th>分类图片：</th>
                                <td>
                                    <?php if(!empty($cate)): ?><img src="/axd<?php echo ($cate["image"]); ?>" id="to_img">
                                        <?php else: ?>
                            ...
                            <tr>
                                <th>排序：</th>
                                <td><input type="text" name="order_n" value="<?php echo ($cate["order_n"]); ?>"></td>
                            </tr>
                        </table>
                    </div>
...
<script>
    ...
    $('#li1_btn').click(function(){
        $('#edit_form').ajaxSubmit({
            url:"/axd/Admin/Collocation/addEditCCate",
            dataType: "json",
            beforeSend: function() {
