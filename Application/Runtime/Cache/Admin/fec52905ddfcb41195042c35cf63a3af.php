...
<!--头部文件-->
    ...
    <style>
        ...
        #myTabContent img{width: 136px;height: 80px;}
    </style>
</head>
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="search">
                <div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/mgctdh/Admin/Index/giftCardList" id="sf">
                        <div class="input-group" style="margin-bottom: 3%;">
                            <input type="text" class="form-control" placeholder="商品名称搜索" value="<?php echo ($keyword); ?>" name="keyword">
                            <a onClick="document.getElementById('sf').submit();" class="input-group-addon"><i class="icon-search"></i></a>
                        </div>
                    </form>
                </div>
                <a href="<?php echo U('Admin/Index/addEditGiftCard');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered" id="list-table">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td><?php echo ($l["pizza"]); ?></td>
                        <td><?php echo ($l["num"]); ?>/<?php echo ($l["exchange_num"]); ?></td>
                        <td><?php echo ($l["add_time"]); ?></td>
                        <td class="operation">
                            <?php if($c['sys_value'] != 1): ?><a href="<?php echo U('Admin/Index/addEditGiftCard',array('id'=>$l['gift_card_id']));?>">编辑</a>
