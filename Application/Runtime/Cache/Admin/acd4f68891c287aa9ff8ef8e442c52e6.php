...
<!--头部文件-->
    ...
    <style>
        ...
        tr img{width:120px;height:60px;}
        .tr_width_3{width: 30%;}
    </style>
    <script type="text/javascript">
        var APP = "/axd";
        var MODULE = "/axd/Admin";
        var CONTROLLER = "/axd/Admin/Interact";
        var ACTION = "/axd/Admin/Interact/interactList";
    </script>
</head>
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/axd/Admin/Interact/interactList" id="sf">
                ...
                <a href="<?php echo U('Admin/Interact/addEditInteract');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        ...
                        <td><?php echo ($l["content_s"]); ?></td>
                        <td><?php echo ($l["user_nickname"]); ?></td>
                        <td><?php echo (date('Y-m-d',$l["time"])); ?></td>
                        <td><?php echo ($l['is_video']==0?'否':'是'); ?></td>
                        <td class="operation">
                            <a href="<?php echo U('Admin/Interact/addEditInteract',array('id'=>$l['interact_id']));?>">编辑</a>
                            <a href="javaScript:void(0);" onclick="delInteract('<?php echo ($l["interact_id"]); ?>');">删除</a>
                        </td>
...
<script>
    //删除校趣
    function delInteract(id){
        if(confirm("是否删除该数据")){
            $.post("<?php echo U('Admin/Interact/delInteract');?>",{'id':id},function(data){
                alert(data.msg);
                if('0'==data.errorCode){
