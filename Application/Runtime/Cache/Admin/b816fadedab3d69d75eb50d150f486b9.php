        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="search">
                <div class="col-sm-4 col-xs-6">
                    <form class="bs-example bs-example-form" action="/mgctdh/Admin/Merchant/merchantList" id="sf">
                ...
                <a href="<?php echo U('Admin/Merchant/addEditMerchant');;?>" class='btn btn-sm btn-primary pull-left'>添加</a>
            </div>
            ...
            <table class="table table-bordered" id="list-table">
                ...
                <?php if(is_array($list)): foreach($list as $k=>$l): ?><tr>
                        <td><?php echo ($k+1); ?></td>
                        <td><?php echo ($l["merchant_name"]); ?></td>
                        <td><?php echo ($l["merchant_address"]); ?></td>
                        <td><img src="/mgctdh<?php echo ($l["image"]); ?>" alt=""></td>
                        <td><?php echo ($l["cuisine"]); ?></td>
                        <td><?php echo ($l["add_time"]); ?></td>
                        <td class="operation">
                            <?php if($c['sys_value'] != 1): ?><a href="<?php echo U('Admin/Merchant/addEditMerchant',array('id'=>$l['merchant_id']));?>">编辑</a>
